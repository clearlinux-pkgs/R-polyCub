...
Version  : 0.6.1
Release  : 6
URL      : https://cran.r-project.org/src/contrib/polyCub_0.6.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/polyCub_0.6.1.tar.gz
Summary  : Cubature over Polygonal Domains
Group    : Development/Tools
License  : GPL-2.0
Requires: R-polyCub-lib
Requires: R-sp
Requires: R-spatstat
BuildRequires : R-sp
...
export LANG=C
export SOURCE_DATE_EPOCH=1530413614
...
/usr/lib64/R/library/polyCub/NEWS.Rd
...
/usr/lib64/R/library/polyCub/examples/plotpolyf.R
/usr/lib64/R/library/polyCub/examples/polyCub.R
/usr/lib64/R/library/polyCub/examples/polyCub.iso.R
...
/usr/lib64/R/library/polyCub/libs/symbols.rds
