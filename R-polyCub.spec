...
Version  : 0.9.2
Release  : 51
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/polyCub_0.9.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/polyCub_0.9.2.tar.gz
...
%package dev
Summary: dev components for the R-polyCub package.
Group: Development
Requires: R-polyCub-lib = %{version}-%{release}
Provides: R-polyCub-devel = %{version}-%{release}
Requires: R-polyCub = %{version}-%{release}

%description dev
dev components for the R-polyCub package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739373808
